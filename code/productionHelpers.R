...
#' 
#' This function takes a data.frame of one WBIC_YEAR ad identifies and returns the appropriate regression results. See workflow document for how "appropriate" is defined.
#' 
#' @param df A data.frame filtered from the FMDB file for one WBIC_YEAR.
